        ...
        <div className={styles.pricing}>
          ...
          <div className={`container ${styles.pricingContainer}`}>
            <div class="pricing-header p-3 pb-md-4 mx-auto text-center">
              <h1 class={`display-4 fw-normal ${styles.pricingHeading}`}>Pricing</h1>
              <p class={`fs-5 text-muted ${styles.pricingSubHeading}`}>Quickly build an effective pricing table for your potential customers with this Bootstrap example. It’s built with default Bootstrap components and utilities with little customization.</p>
            </div>
              ...
              <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                  ...
                  <div class="card-body">
                    ...
                    <button type="button" class={`w-100 btn ${styles.customBtn} ${styles.btn}`}>Sign up for free</button>
                  </div>
                </div>
              </div>
              <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm">
                  ...
                  <div class="card-body">
                    ...
                    <button type="button" class={`w-100 btn ${styles.customBtn} ${styles.btn}`}>Get started</button>
                  </div>
                </div>
              </div>
              <div class="col">
                <div class="card mb-4 rounded-3 shadow-sm border-primary">
                  <div class={`card-header py-3 border-primary ${styles.priceCardActive}`}>
                  ...
                  <div class="card-body">
                    ...
                    <button type="button" class={`w-100 btn ${styles.customBtn} ${styles.btn}`}>Contact us</button>
                  </div>
                </div>
              </div>
            </div>
          </div>
          <Image src={pricingBtm} width='1920' height='301' className={styles.featureBg} alt='feature bgTop' />
        </div>
